        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <div className="relative">
              {/* Profile Image */}
              <div className="relative w-80 h-80 sm:w-80 sm:h-80 rounded-full overflow-hidden border-4 border-primary/20 shadow-xl hover-glow">
                <Image
              ...
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary/40 to-secondary/40 opacity-0 hover:opacity-10 transition-opacity duration-300" />
            </div>
          </motion.div>
            ...
            <div className="space-y-2">
              ...
              >
                <h1 className="text-xl font-bold tracking-tighter sm:text-3xl xl:text-4xl/none">
                  Hi, I&apos;m Sathishkumar Ranganathan
                </h1>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                Full-stack Software Developer passionate about creating scalable
                web applications and smart systems with React.js, Next.js, PHP,
                and Flutter.
              </motion.p>
            </div>
